...
#ifndef GAUSSIANSPLATVIEWER_SWIFT_H
#define GAUSSIANSPLATVIEWER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GaussianSplatViewer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@protocol MTLDevice;
@class NSCoder;
SWIFT_CLASS("_TtC19GaussianSplatViewer18InteractiveMTKView")
...
SWIFT_CLASS("_TtC19GaussianSplatViewer8Renderer")
